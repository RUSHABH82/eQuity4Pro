...
@Service
public class TickerTapeLiveDetailService implements LiveDetailService {
    ...
    public TickerTapeLiveDetailService() throws LiveUpdateException {
    ...
    public LiveDetailsResponse mapStockToTickerTapeResponse(TickerTapeModels.Stock stock) {
        LiveDetailsResponse liveDetailsResponse = new LiveDetailsResponse();
        liveDetailsResponse.setSymbol(stock.getInfo().getTicker());
        liveDetailsResponse.setName(stock.getInfo().getName());
        liveDetailsResponse.setSector(stock.getInfo().getSector());
        liveDetailsResponse.setLastPrice(stock.getAdvancedRatios().getLastPrice());
        liveDetailsResponse.setIndustry(stock.getAdvancedRatios().getSubindustry());
        liveDetailsResponse.setMarketCapInCr(stock.getAdvancedRatios().getMrktCapf());
